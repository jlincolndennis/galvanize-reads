...
exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    knex('authors').insert({first_name: "Alex",
                            last_name: "Martelli",
    ...
    knex('authors').insert({first_name: "Anna",
    ...
    knex('authors').insert({first_name: "Steve",
                            last_name: "Holden",
    ...
    knex('authors').insert({first_name: "Allen B.",
                            last_name: "Downey",
    ...
    knex('authors').insert({first_name: "Bonnie",
                            last_name: "Eisenman",
    ...
    knex('authors').insert({first_name: "Kyle",
                            last_name: "Simpson",
