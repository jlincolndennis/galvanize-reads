...
exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    knex('books').insert({title: "Think Python",
                          genre: "Python",
    ...
    knex('books').insert({title: "Learning React Native",
                          genre: "JavaScript",
    ...
    knex('books').insert({title: "You Don't Know JS: ES6 & Beyond",
                          genre: "JavaScript",
    ...
    knex('books').insert({title: "You Don't Know JS: Scope & Closures",
                          genre: "JavaScript",
    ...
    knex('books').insert({title: "You Don't Know JS: Async & Performance",
                          genre: "JavaScript",
